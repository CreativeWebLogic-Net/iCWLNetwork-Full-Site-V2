...
<link href="{{asset-sever}}bcms/templates/gcwd/css/general.css" rel="stylesheet" type="text/css" />
</head>
	...
	<div id="MainBodyCentered">
        ...
        <div id="BodyContent">
            ...
            <div id="RightBodyContent">
                <img src="{{asset-sever}}bcms/templates/gcwd/images/MainBody-Picture.jpg" alt="gold coast web design development" width="282" height="173" align="left" />
                <h2>{{main-title}}</h2>
                {{main-content}}
